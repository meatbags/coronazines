...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _zine__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./zine */ \"./js/modules/zine.js\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n/** Zine manager */\n\n\nvar ZineManager = /*#__PURE__*/function () {\n  function ZineManager() {\n    _classCallCheck(this, ZineManager);\n\n    this.zines = [];\n  }\n\n  _createClass(ZineManager, [{\n    key: \"resize\",\n    value: function resize() {\n      this.zines.forEach(function (zine) {\n        zine.resize();\n      });\n    }\n  }, {\n    key: \"bind\",\n    value: function bind() {\n      var pages = [];\n      var data = document.querySelector('#data-target');\n      data.querySelectorAll('.page').forEach(function (el) {\n        pages.push(el.innerHTML);\n      });\n      var zine = new _zine__WEBPACK_IMPORTED_MODULE_0__[\"default\"]({\n        title: data.dataset.title,\n        pages: pages\n      });\n      zine.show();\n      this.zines.push(zine);\n    }\n  }]);\n\n  return ZineManager;\n}();\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (ZineManager);\n\n//# sourceURL=webpack://GHOSTS/./js/modules/zine_manager.js?");
